		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-4 my-3">
				<div class="card m-auto" style="width: 18rem;">
					...
					<img src="images/<?php echo $client['cimage']; ?>" class="img-fluid card-img-top" alt="">

					<div class="card-body">
						<p class="card-text text-center text-dark font-size-16 font-rb "><?php echo $client['cname']; ?></p>
					</div>
				</div>
			</div>
			<?php }?>
